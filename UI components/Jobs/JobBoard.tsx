...
export default function JobBoard() {
  ...
  const { data: jobs, isLoading, error } = useJobs({ offset: offset, location, category, title });

  if (!jobs) return <div className="text-gray-500 text-center pt-4 text-lg">No jobs found</div>;
